...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/rfU_xT-vT/',modelLoaded);
...
function gotResult(error, results) {
  if (error) {
    ...
    {
	    document.getElementById("update_object").innerHTML = "&#128077;";
    }
    ...
    {
	    document.getElementById("update_object2").innerHTML = "&#128077;";
    }
